...
public class BookDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load(Uri.parse(book.getCoverUrl())).listener(new RequestListener<Drawable>() {
            @Override
        ...
        }).apply(new RequestOptions().placeholder(R.drawable.ic_nocover)).into(ivBookCover);
    ...
    public Uri getBitmapFromDrawable(Bitmap bmp){
        ...
        try {
            ...
            Log.e("BitmapLogger",e.getMessage());
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // Locate Menu Item with SAP
        MenuItem item = menu.findItem(R.id.menu_item_share);
        // Fetching reference
        miShareAction = (ShareActionProvider) MenuItemCompat.getActionProvider(item);
        attachShareIntentAction();
        // true for displaying menu
        return true;
    }
